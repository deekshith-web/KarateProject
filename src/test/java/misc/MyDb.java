...
public class MyDb
{
    private static String dbUrl = "jdbc:sqlserver://192.168.1.61\\MSSQLSERVER;DatabaseName=Testingdb;";

    public static String selectStatement(String stmt)
    {
        try
        {
            Connection con = DriverManager.getConnection(dbUrl,"sa", "P@ssw@rd");
